...
from src.retrieve_10k import exhaustive_query as tenk_pipeline, section_summaries
import os
import openai
...
def multimodal_agent(query, company, year):
    ...
    tenk_output = tenk_pipeline(query, company, year, section_summaries, removed = [])[0]
    print(tenk_output)
